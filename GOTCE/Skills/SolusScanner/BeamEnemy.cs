...
{
    public class BeamEnemy : SkillBase<BeamEnemy>
    {
        public override SerializableEntityStateType ActivationState => new SerializableEntityStateType(typeof(EntityStatesCustom.SolusScanner.BeamEnemy));
        ...
        public override string NameToken => "GOTCE_BeamEnemy_NAME";

        public override string DescToken => "GOTCE_BeamEnemy_DESC";
