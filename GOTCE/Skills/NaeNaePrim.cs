...
{
    public class NaeNaePrim : SkillBase<NaeNaePrim>
    {
        public override SerializableEntityStateType ActivationState => new SerializableEntityStateType(typeof(EntityStatesCustom.NaeNaeLord.NaeNaeWhip));
        ...
        public override string NameToken => "GOTCE_NAENAEPRIM_NAME";

        public override string DescToken => "GOTCE_NAENAEPRIM_DESC";
