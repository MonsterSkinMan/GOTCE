...
namespace GOTCE.Items.Lunar
{
    public class DopeDope : ItemBase<DopeDope>
    {
        ...
        public override string ItemFullDescription => "Divide your <style=cIsDamage>base damage</style> by <style=cIsDamage>12</style> and multiply your <style=cIsDamage>attack speed</style> by <style=cIsDamage>12</style>.";
