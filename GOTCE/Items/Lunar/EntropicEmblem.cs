...
namespace GOTCE.Items.Lunar
{
    public class EntropicEmblem : ItemBase<EntropicEmblem>
    {
        ...
        public override string ItemFullDescription => "Instantly <style=cIsUtility>delete</style> all enemies, allies, projectiles, and interactables within <style=cIsUtility>30m</style> <style=cStack>(+30m per stack)</style> of you.";
