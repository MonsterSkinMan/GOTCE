...
namespace GOTCE.Items.Red
{
    public class PSG13 : ItemBase<PSG13>
    {
        ...
        public override string ItemFullDescription => "gain <style=cIsUtility>104%</style> <style=cStack>(+104% per stack)</style> <style=cIsUtility>of yrou max hp in shield</style>. <style=cIsUtility>recharges outside of danger</style>. thirteen personal shield generators is a videogame won. ensures a good run.";
