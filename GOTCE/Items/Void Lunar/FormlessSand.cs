...
namespace GOTCE.Items.VoidLunar
{
    public class FormlessSand : ItemBase<FormlessSand>
    {
        ...
        public override string ItemFullDescription => "<style=cIsHealing>Increase maximum health by 100%</style> <style=cStack>(+100% per stack)</style>. <style=cIsDamage>Reduce base damage by 50%</style> <style=cStack>(+50% per stack)</style>. <style=cIsVoid>Corrupts all Shaped Glasses</style>.";
