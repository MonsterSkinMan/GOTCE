...
namespace GOTCE.Items.White
{
    public class Barrierworks : ItemBase<Barrierworks>
    {
        ...
        public override Enum[] ItemTags => new Enum[] { ItemTag.Healing, ItemTag.Utility, ItemTag.InteractableRelated, ItemTag.AIBlacklist, GOTCETags.BarrierRelated };

        public override GameObject ItemModel => null;

        public override Sprite ItemIcon => Main.MainAssets.LoadAsset<Sprite>("Assets/Textures/Icons/Item/barrierworks.png");
