...
namespace GOTCE.Items.Green
{
    public class AmberRabbit : ItemBase<AmberRabbit>
    {
        ...
        public override string ItemFullDescription => "Gain <style=cIsUtility>5% stage transition crit chance</style>. On '<style=cIsUtility>Stage Transition Crit</style>', <style=cIsUtility>multiply your item count by 2</style> <style=cStack>(+1 per stack)</style>.";
