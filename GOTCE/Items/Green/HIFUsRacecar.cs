...
namespace GOTCE.Items.Green
{
    public class HIFUsRacecar : ItemBase<HIFUsRacecar>
    {
        ...
        public override string ItemPickupDesc => "Gain 3 Backup Mags. On ‘Sprint Crit’ instantly recharge all charges of your Secondary skill. Reduce Secondary skill cooldown.";

        public override string ItemFullDescription => "Gain <style=cIsUtility>3</style> Backup Mags. Gain <style=cIsUtility>5% sprint crit chance</style>. On '<style=cIsUtility>sprint crit</style>', <style=cIsUtility>recharge</style> all of your <style=cIsUtility>secondary charges</style>. Gain <style=cIsUtility>10%</style> <style=cStack>(+15% per stack)</style> <style=cIsUtility>cooldown reduction</style> for your <style=cIsUtility>secondary skill</style>.";
        ...
        public override Sprite ItemIcon => Main.MainAssets.LoadAsset<Sprite>("Assets/Textures/Icons/Item/HIFUsRacecar.png");
        ...
        private void Inventory_GiveItem_ItemIndex_int(On.RoR2.Inventory.orig_GiveItem_ItemIndex_int orig, Inventory self, ItemIndex itemIndex, int count)
        {
            ...
            {
                for (int i = 0; i < 3; i++)
                    self.GiveItem(RoR2Content.Items.SecondarySkillMagazine);
            }
        }
