...
namespace GOTCE.Items.Green
{
    public class AegmergencyAegis : ItemBase<AegmergencyAegis>
    {
        ...
        public override string ItemFullDescription => "All sources of <style=cIsHealing>barrier>/style> are increased by a flat <style=cIsHealing>30</style> <style=cStack>(+15 per stack)</style> for every Backup Magazine you have.";
