...
namespace GOTCE.Items.Green
{
    public class Gasogreen : ItemBase<Gasogreen>
    {
        ...
        public override string ItemFullDescription => "On kill, deal <style=cIsDamage>150% base damage</style> to all enemies within <style=cIsDamag>24m</style> <style=cStack>(+8m per stack)</style> and <style=cIsUtility>weaken</style> them permanently.";
