...
namespace GOTCE.Items.Yellow
{
    public class NeverEndingAgony : ItemBase<NeverEndingAgony>
    {
        ...
        public override Enum[] ItemTags => new Enum[] { ItemTag.Damage, ItemTag.Utility, ItemTag.Healing, ItemTag.AIBlacklist, GOTCETags.Bullshit, GOTCETags.NonLunarLunar, GOTCETags.Masochist };
