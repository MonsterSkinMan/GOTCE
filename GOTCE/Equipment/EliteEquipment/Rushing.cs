...
namespace GOTCE.Equipment.EliteEquipment
{
    class Rushing : EliteEquipmentBase<Rushing>
    {
        ...
        public override Texture2D EliteRampTexture => Main.SecondaryAssets.LoadAsset<Texture2D>("Assets/Prefabs/EliteOverlays/Backup.png"); //Change this to rushing elite ramp at some point
        ...
        public override Sprite EliteEquipmentIcon => Main.SecondaryAssets.LoadAsset<Sprite>("Assets/Prefabs/Equipment/Backup/BackupIcon.png"); //You know the drill
