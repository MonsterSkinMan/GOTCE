...
namespace GOTCE.Equipment
{
    public class LunarCrunder : EquipmentBase<LunarCrunder>
    {
        ...
        public override string EquipmentFullDescription => "Fire a rapid stream of lunar shards for 5000% damage with a 5.0 proc coeff. Consumes 1 Lunar Coin per second of firing.";
