...
namespace GOTCE.Based
{
    public class SuppressiveNader
    {
        public static void Hook()
        {
            ...
            LanguageAPI.Add(Skills.SuppressiveNader.Instance.SkillDef.skillDescriptionToken, "Fires 6 stunning nades that explode on impact, spawn multiple allies on hit, apply almost every debuff, spawn every portal, eradicate crowdfunder from the universe, give the regenerative buff, and cleanse debuffs.");
