...
namespace GOTCE.Based
{
    public class AltSkills
    {
        ...
        private static void RGAlts()
        {
            ...
            LanguageAPI.Add(Skills.DumbRounds.Instance.SkillDef.skillDescriptionToken, "Fire a highly inaccurate spread of <style=cIsDamage>6</style> rounds for <style=cIsDamage>100% damage</style> each.");
